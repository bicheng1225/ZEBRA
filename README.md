...
### 🚀  Methodology: The LABRA Pipeline
The following figure illustrates the overall architecture of LABRA. Our framework systematically processes blockchain transaction data through a zero-shot learning paradigm to identify illicit accounts.

<p align="center">
<img src="zebra-5.png" width="800" alt="ZEBRA Overall Pipeline">

<em>Figure 1: The overall pipeline of LABRA, showcasing the flow from transaction networks to illicit account detection.</em>
</p>
...
| 🚀 **Ours** | **LABRA** | **75.20** | **74.65** | **65.09** | **27.87** |
